...
class Detector:
    ...
    def cal_usad_anomaly_score(self, metric: str, description: str,
        ...
        if key == "machine_id":
            ...
            ts_standard_list = self.data_loader.get_metric(start, end, metric, operator='avg', keys="machineid", machineid=machine_id)
        else:
        ...
        if ts_standard_list:
            ...
            if key == "machine_id":
                ...
                ts_list = self.data_loader.get_single_metric(
                    start, end, metric, keys="machineid", machineid=machine_id) 
            else:
